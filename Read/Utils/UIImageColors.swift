...
extension UIImage {
    ...
    // TODO: FIX MAYBE ERROR
    public func getColors(quality: UIImageColorsQuality = .high, _ completion: @escaping @Sendable (UIImageColors?) -> Void) {
...
func getImageColors(imagePath: URL?) -> UIImageColors? {
    if let imagePath = imagePath, let data = try? Data(contentsOf: imagePath) {
